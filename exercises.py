...
def create_awesome_students():
    ...
    for student in students:
        message = student + " is awesome!"
        awesome_students.append(message)
...
def filter_foods_with_a():
    # your code here
    foods = ("Ramen", "Pho", "Malatang", "Aegean Fish Soup", "Minestrone", "Clam Chowder")

    foods_with_letter_a = []

    for food in foods:
        if 'a' in food or 'A' in food:
            foods_with_letter_a.append(food)

    return foods_with_letter_a
